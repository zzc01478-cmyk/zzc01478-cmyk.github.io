...
function countryMark(code) {
  if (code === 'SIM') return '<span class="country-mark">SIM</span>';
  const names = { GB: '英国', DE: '德国', HK: '香港', PH: '菲律宾', US: '美国' };
  return `<span class="country-mark"><img src="https://flagcdn.com/${code.toLowerCase()}.svg" alt="${names[code] || code}旗帜" referrerpolicy="no-referrer"></span>`;
}
